...
\newcommand{\aspevt}{\cnc{id_{ASP}}}
\newcommand{\aspn}{\cnc{ASP}}

\newcommand{\aspt}[2]{\cnc{ASP}~#1~#2}
%\newcommand{\asptn}[4]{\cnc{ASP}~#1~#2~#3~#4}
\newcommand{\asptn}[2]{\cnc{ASP}~#1~#2}
\newcommand{\asptnn}[1]{\cnc{ASP}~#1~}
...
\newcommand{\etn}{\cnc{E}}
\newcommand{\Mtn}{\cnc{mt}_{\etn}}
\newcommand{\Utn}{\cnc{ASP}_{\etn}}
\newcommand{\Gtn}{\cnc{SIG}_{\etn}}
\newcommand{\Htn}{\cnc{HSH}_{\etn}}
\newcommand{\Ntn}{\cnc{N}_{\etn}}
\newcommand{\SStn}{\cnc{SS}_{\etn}}
\newcommand{\PPtn}{\cnc{PP}_{\etn}}

%\newcommand{\Ut}[6]{\Utn~#1~#2~#3~#4~#5~#6}
\newcommand{\Ut}[3]{\Utn~#1~#2~#3}
\newcommand{\Utt}[3]{\Utn~#1~#2~#3~}
\newcommand{\Gt}[2]{\Gtn~#1~#2}
\newcommand{\Ht}[2]{\Htn~#1~#2}
\newcommand{\Nt}[1]{\Ntn~#1}
\newcommand{\SSt}[2]{\SStn \hspace{1mm} {#1} \hspace{1mm} {#2}}
\newcommand{\PPt}[2]{\PPtn \hspace{1mm} {#1} \hspace{1mm} {#2}}

%\newcommand{\Utc}[6]{\cnc{\aspn_{c}}~#1~#2~#3~#4~#5~#6}
\newcommand{\Utc}[4]{\cnc{\aspn_{c}}~#1~#2~#3~#4}
\newcommand{\Gtc}[3]{\cnc{\sig_{c}}~#1~#2~#3}
\newcommand{\Htc}[3]{\cnc{\hsh_{c}}~#1~#2~#3}
\newcommand{\Ntc}[2]{\cnc{N_{c}}~#1~#2}
\newcommand{\SStc}[2]{\cnc{SS_{c}} \hspace{1mm} {#1} \hspace{1mm} {#2}}
\newcommand{\PPtc}[2]{\cnc{PP_{c}} \hspace{1mm} {#1} \hspace{1mm} {#2}}
...
%\(E_{m}=\alpha_{m}x+y\)
%\newcommand{\evt}[0]{\cnc{\(E_{m}=\alpha_{m}x+y\)}}
%\newcommand{\evt}[0]{\(E_{m}=\alpha_{m}x+y\)}
%\newcommand{\evtc}[0]{\cnc{\emph{E_{c}}} }
\newcommand{\evt}[0]{\cnc{\emph{E}_\emph{T}} }
...
\newcommand{\adtj}{\cnc{<ADT>}}
\newcommand{\strj}{\cnc{<string>}}
\newcommand{\numj}{\cnc{<number>}}
\newcommand{\arrj}{\cnc{<array>}}
\newcommand{\tj}{\cnc{<term>}}
\newcommand{\ej}{\cnc{<evidence\_type>}}
\newcommand{\ejc}{\cnc{<evidence\_conc>}}
\newcommand{\rawevj}{\cnc{<raw\_evidence>}}
\newcommand{\spj}{\cnc{<SP>}}
\newcommand{\bsj}{\cnc{<b64\_string>}}
\newcommand{\aspcj}{\cnc{<asp\_params>}}
\newcommand{\namej}{\cnc{<nameMap>}}
